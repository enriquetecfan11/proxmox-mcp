...
### Introducción
- [Visión general](./intro/overview.md)
- [Características](./intro/features.md)
- [Requisitos](./intro/requirements.md)
- [Inicio rápido](./intro/getting-started.md)

### Configuración
- [Configuración](./setup/configuration.md)
- [Autenticación](./setup/authentication.md)
...
- [Estructura del proyecto](./dev/structure.md)
- [Solución de problemas](./dev/troubleshooting.md)

### Despliegue y mantenimiento
- [Despliegue](./ops/deployment.md)
- [Changelog](./ops/changelog.md)
- [Referencias](./ops/references.md)
- [Licencia](../LICENSE)

 ---

 Si buscas una guía rápida, comienza por [Inicio rápido](./intro/getting-started.md). Para detalles de endpoints, visita [API HTTP](./usage/http-api.md).
